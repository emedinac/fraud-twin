...
The current documentation and API reference describe the package version named
in the project metadata. Use the version selector to compare examples against
another release and consult the changelog for feature-level notes.
